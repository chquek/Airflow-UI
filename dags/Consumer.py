...
default_args = AttrDict({'owner': 'anybody', 'start_date_old': '2023-07-22T10:03', 'start_date': '2023-09-10T00:00'})
...
schedule = None
schedule = []
schedule.append(Dataset('file:///workarea/file1.txt'))
schedule.append(Dataset('file:///workarea/file2.txt'))
