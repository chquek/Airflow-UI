...
tasks = [{'id': 248, 'pid': 7, 'name': 'Create', 'operator': 'SQLExecuteQuery', 'body': {'depend': [338], 'detail': {'baseop': 'from udm.customOperator.SQLExecuteQuery import SQLExecuteQueryOperator', 'callback': {}, 'conn_id': 'kinisi-postgres', 'dataset': None, 'doc_md': 'Need to create connection id :  Postgres ,  db/user/pw = airflow', 'note': 'https://airflow.apache.org/docs/apache-airflow-providers-common-sql/stable/operators.html', 'passthru': 'False', 'return_last': None, 'runnable': "SQLExecuteQueryOperator(task_id=taskname, ** ( t.kwargs ( [ 'sql' , 'split_statements' , 'return_last' , 'conn_id'  ] ) ) ,  default_args=task_opargs , doc_md=doc_md , **callback , **dataset , **other_args , params=dagparams )", 'split_statements': 'true', 'sql': "DROP TABLE IF EXISTS tab1 ;\nCREATE TABLE tab1 (\n    id integer ,\n    name char(50)\n);\ninsert into tab1 values ( 100 , 'Eileen' ) ;\ninsert into tab1 values ( 101 , 'Michael' );\n", 'task_opargs': {}, 'task_params': {}, 'trigger': 'all_success', 'other_args': {'trigger_rule': 'all_success'}}}, 'bfield': None}, {'id': 337, 'pid': 7, 'name': 'Reader', 'operator': 'Python', 'body': {'depend': [248], 'detail': {'baseop': 'from udm.customOperator.Python import PythonOperator', 'callback': {}, 'dataset': None, 'doc_md': None, 'python_callable': 'udm.Template.info', 'runnable': "PythonOperator ( task_id=taskname,  ** ( t.kwargs ( [ 'python_callable' ] ) ) ,  default_args=task_opargs , doc_md=doc_md , **callback , **dataset , **other_args , params=dagparams )", 'task_opargs': {}, 'task_params': {}, 'trigger': 'all_success', 'other_args': {'trigger_rule': 'all_success'}}}, 'bfield': None}, {'id': 249, 'pid': 7, 'name': 'Select', 'operator': 'SQLExecuteQuery', 'body': {'depend': [248], 'detail': {'baseop': 'from udm.customOperator.SQLExecuteQuery import SQLExecuteQueryOperator', 'callback': {}, 'conn_id': 'kinisi-postgres', 'dataset': None, 'doc_md': None, 'note': 'https://airflow.apache.org/docs/apache-airflow-providers-common-sql/stable/operators.html', 'passthru': 'False', 'return_last': None, 'runnable': "SQLExecuteQueryOperator(task_id=taskname, ** ( t.kwargs ( [ 'sql' , 'split_statements' , 'return_last' , 'conn_id'  ] ) ) ,  default_args=task_opargs , doc_md=doc_md , **callback , **dataset , **other_args , params=dagparams )", 'split_statements': 'true', 'sql': 'select * from tab1 ;\nDROP TABLE IF EXISTS tab1 ;', 'task_opargs': {}, 'task_params': {}, 'trigger': 'all_success', 'other_args': {'trigger_rule': 'all_success'}}}, 'bfield': None}, {'id': 338, 'pid': 7, 'name': 'Start', 'operator': 'Python', 'body': {'depend': [], 'detail': {'baseop': 'from udm.customOperator.Python import PythonOperator', 'callback': {}, 'dataset': None, 'doc_md': None, 'python_callable': 'udm.Template.info', 'runnable': "PythonOperator ( task_id=taskname,  ** ( t.kwargs ( [ 'python_callable' ] ) ) ,  default_args=task_opargs , doc_md=doc_md , **callback , **dataset , **other_args , params=dagparams )", 'task_opargs': {}, 'task_params': {}, 'trigger': 'all_success', 'other_args': {'trigger_rule': 'all_success'}}}, 'bfield': None}]
