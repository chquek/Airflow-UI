...
dag_kwargs = AttrDict ( {'owner_links': AttrDict({'kinisi': 'https://www.kinisi.biz'}), 'concurrency': 8, 'catchup': True, 'tags': ['feature'], 'doc_md': '# Header - DAG Markdown notes\n\n- See this for : [default arg options](https://airflow.apache.org/docs/apache-airflow/1.10.8/tutorial.html#default-arguments)\n'}  )
default_args = AttrDict({'owner': 'kinisi', 'start_date_old': '2023-08-02T22:50', 'start_date': '2023-09-28T00:00'})
