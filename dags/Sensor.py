...
tasks = [{'id': 211, 'pid': 73, 'name': 'Sensor1', 'operator': 'FileSensor', 'body': {'depend': [], 'detail': {'baseop': 'from airflow.sensors.filesystem import FileSensor', 'callback': {}, 'dataset': None, 'doc_md': None, 'filepath': '/workarea/file1', 'fs_conn_id': None, 'mode': 'poke', 'poke_interval': 60, 'runnable': "FileSensor( task_id=taskname , ** ( t.kwargs ( [ 'filepath' , 'poke_interval' , 'mode' , 'timeout' , 'fs_conn_id' ] ) ) ,  default_args=task_opargs , doc_md=doc_md , **callback , **dataset , **other_args , params=dagparams )", 'task_opargs': {}, 'task_params': {}, 'timeout': 1800, 'trigger': 'all_success', 'other_args': {'trigger_rule': 'all_success'}}}, 'bfield': None}, {'id': 243, 'pid': 73, 'name': 'Sensor2', 'operator': 'FileSensor', 'body': {'depend': [], 'detail': {'baseop': 'from airflow.sensors.filesystem import FileSensor', 'callback': {}, 'dataset': None, 'doc_md': None, 'filepath': '/workarea/file2', 'fs_conn_id': None, 'mode': 'reschedule', 'poke_interval': 60, 'runnable': "FileSensor( task_id=taskname , ** ( t.kwargs ( [ 'filepath' , 'poke_interval' , 'mode' , 'timeout' , 'fs_conn_id' ] ) ) ,  default_args=task_opargs , doc_md=doc_md , **callback , **dataset , **other_args , params=dagparams )", 'task_opargs': {}, 'task_params': {}, 'timeout': 1800, 'trigger': 'all_success', 'other_args': {'trigger_rule': 'all_success'}}}, 'bfield': None}, {'id': 212, 'pid': 73, 'name': 'Start', 'operator': 'Python', 'body': {'depend': [211, 243], 'detail': {'baseop': 'from udm.customOperator.Python import PythonOperator', 'callback': {}, 'dataset': None, 'doc_md': None, 'python_callable': 'udm.Template.info', 'runnable': "PythonOperator ( task_id=taskname,  ** ( t.kwargs ( [ 'python_callable' ] ) ) ,  default_args=task_opargs , doc_md=doc_md , **callback , **dataset , **other_args , params=dagparams )", 'task_opargs': {}, 'task_params': {}, 'trigger': 'all_success', 'other_args': {'trigger_rule': 'all_success'}}}, 'bfield': None}]
dagparams = AttrDict({})

dag_kwargs = AttrDict ( {'owner_links': AttrDict({}), 'concurrency': 8, 'catchup': True, 'tags': ['feature', 'sensor'], 'doc_md': '# Header - DAG Markdown notes\n\n- See this for : [default arg options](https://airflow.apache.org/docs/apache-airflow/1.10.8/tutorial.html#default-arguments)\n'}  )
default_args = AttrDict({'owner': 'anybody', 'start_date_old': '2023-08-03T15:46', 'start_date': '2023-09-28T00:00'})

'''
'''
dag_kwargs.owner_links = AttrDict({})
dag_kwargs.tags = ['feature', 'sensor']
