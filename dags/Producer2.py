...
tasks = [{'id': 350, 'pid': 33, 'name': 'Task1', 'operator': 'Python', 'body': {'depend': [], 'detail': {'baseop': 'from udm.customOperator.Python import PythonOperator', 'callback': {}, 'dataset': 'file:///workarea/file2.txt', 'doc_md': None, 'python_callable': 'udm.DataSet.touch', 'runnable': "PythonOperator ( task_id=taskname,  ** ( t.kwargs ( [ 'python_callable' ] ) ) ,  default_args=task_opargs , doc_md=doc_md , **callback , **dataset , **other_args , params=dagparams )", 'task_opargs': {}, 'task_params': {}, 'trigger': 'all_success', 'other_args': {'trigger_rule': 'all_success'}}}, 'bfield': None}]
...
default_args = AttrDict({'owner': 'anybody', 'start_date_old': '2023-07-25T21:35', 'start_date': '2023-09-28T00:00'})
